...
当前仓库根目录暂未提供独立的 `LICENSE` 文件，而仓库中包含或改造了多个开源项目的代码。

在进一步公开发布、分发或接受外部贡献前，建议：

1. 梳理根目录与各子目录的上游许可证；
2. 在仓库根目录补充项目自己的 `LICENSE`；
3. 必要时增加 `NOTICE` / `THIRD_PARTY_LICENSES`；
4. 对自研代码与上游代码的边界进行明确说明。

在此之前，请以对应上游项目各自许可证要求为准。
