...
def main():
    ...
    c=Model18000Contract.from_onnx_session(s,a.onnx_path);core=Guarded18000PolicyCore(s,c)
    durations=[]
    for i in range(1000):
    ...
    print(json.dumps(dict(model='B18000',sha256=EXPECTED_ONNX_SHA256,policy_hz=1/c.policy_dt,
